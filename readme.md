...
1. [Tutorial 3](./tut_fwb_3.md): How to create a create a simple dialog for a Workbench command that includes an input box where a parameter can be set.
1. [Tutorial 4](./tut_fwb_4.md): Expand tutorial 3 to have 3 parameters to set. The form is arranged in a grid.
